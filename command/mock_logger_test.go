...
// using the command
// $ go-mockgen -f github.com/efritz/ij/logging -i Logger -o mock_logger_test.go

package command

import logging "github.com/efritz/ij/logging"

// MockLogger is a mock impelementation of the Logger interface (from the
// package github.com/efritz/ij/logging) used for unit testing.
...
func (m *MockLogger) Debug(v0 *logging.Prefix, v1 string, v2 ...interface{}) {
	...
	m.DebugFunc.history = append(m.DebugFunc.history, LoggerDebugFuncCall{v0, v1, v2})
	return
}
...
// Debug method of the parent MockLogger instance inovkes the hook at the
...
func (m *MockLogger) Error(v0 *logging.Prefix, v1 string, v2 ...interface{}) {
	...
	m.ErrorFunc.history = append(m.ErrorFunc.history, LoggerErrorFuncCall{v0, v1, v2})
	return
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Error method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
func (m *MockLogger) Info(v0 *logging.Prefix, v1 string, v2 ...interface{}) {
	...
	m.InfoFunc.history = append(m.InfoFunc.history, LoggerInfoFuncCall{v0, v1, v2})
	return
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Info method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
func (m *MockLogger) Warn(v0 *logging.Prefix, v1 string, v2 ...interface{}) {
	...
	m.WarnFunc.history = append(m.WarnFunc.history, LoggerWarnFuncCall{v0, v1, v2})
	return
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Warn method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
